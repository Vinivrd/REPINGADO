        ...
        <div className="relative w-full flex flex-col items-center">
            ...
            <div className="w-full flex justify-center relative">
                <img 
                    ...
                    alt="background" 
                />
                <div className="absolute bottom-0 left-[5%] sm:left-[25%] md:left-[27.5%] lg:left-[30%] w-[90%] sm:w-[50%] md:w-[45%] lg:w-[40%] h-20 sm:h-32 md:h-40 lg:h-48 bg-gradient-to-t from-white to-transparent"></div>
            </div>
            <WhatsappButton />
        </div>
    )
