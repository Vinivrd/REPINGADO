...
const Home = () => {
    return(
        <div className="relative w-full">
            <h1 className="flex items-center justify-center nanum-pen-script text-7xl sm:text-8xl md:text-9xl lg:text-[10rem] font-bold z-10 px-4 text-center">Repingado</h1>
